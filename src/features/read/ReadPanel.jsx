            ...
            <div onClick={()=>{
              ...
              <div style={{position:"relative",zIndex:4,width:"100%",display:"flex",flexDirection:"row",alignItems:"center",padding:"16px 28px 16px 28px",gap:20}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:0,flex:1,minWidth:0}}>
                  ...
                  <span style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(20px,4.8vw,38px)",fontWeight:700,fontStyle:"italic",color:"#FFFFFF",lineHeight:1.15,marginBottom:16,textShadow:"0 2px 8px rgba(0,0,0,0.95),0 1px 3px rgba(0,0,0,0.9)",overflow:"hidden",display:"-webkit-box",WebkitLineClamp:3,WebkitBoxOrient:"vertical"}}>{heroBook.title}</span>
                  {!heroIsDefault && (
