function ReaderOnboardingOverlay({profile, onComplete, onStageChange, onBack}) {
  ...
  const shellCard = {
    ...
    minHeight:isMobile ? "auto" : "min(610px, calc(100vh - 180px))",
  ...
  return (
    <div style={{
      ...
      <div style={shellCard}>
        ...
        {step===0 && !selectedBook && (
          <div style={{display:"grid",gridTemplateColumns:isMobile?"repeat(1, minmax(0, 1fr))":"repeat(3, minmax(0, 1fr))",gap:isMobile?10:16,flex:1}}>
            {books.map((book)=>(
              <button
                key={book.id}
                onClick={()=>{
              ...
              >
                <div style={{height:isMobile?130:228,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(255,255,255,0.78)",borderRadius:"6px 14px 14px 6px",boxShadow:"0 14px 24px rgba(0,0,0,0.1)",overflow:"hidden"}}>
        ...
        {step===0 && selectedBook && (
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"0.68fr 1.32fr",gap:isMobile?10:16,flex:1}}>
            <div style={{...softCard,padding:"18px 18px 14px",display:"flex",flexDirection:"column"}}>
              ...
              <div style={{height:isMobile?180:340,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(255,255,255,0.78)",borderRadius:"6px 14px 14px 6px",boxShadow:"0 12px 22px rgba(0,0,0,0.1)",overflow:"hidden",marginBottom:12,padding:"14px 16px"}}>
        ...
        {step===1 && tutorialMoment && (
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"0.92fr 1.08fr",gap:isMobile?10:16,flex:1}}>
        ...
        {step===2 && tutorialMoment && sofiaProfile && (
          <div style={{display:"flex",flexDirection:"column",gap:14,flex:1,minHeight:0}}>
            <div style={{position:"relative",display:"grid",gridTemplateColumns:isMobile?"1fr":"minmax(0,1fr) 210px minmax(0,1fr)",gap:isMobile?10:16,alignItems:"stretch",minHeight:0}}>
              ...
              <div style={{...softCard,padding:"20px 16px",display:"flex",flexDirection:"column",justifyContent:"space-between",alignItems:"center",gap:14,position:"relative",zIndex:1,minHeight:0,background:"linear-gradient(160deg, #221508 0%, #1A0F08 40%, #0E0A05 100%)",border:"1px solid rgba(212,184,122,0.42)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.05), 0 0 0 1px rgba(196,160,85,0.08), 0 8px 32px rgba(139,105,20,0.18)"}}>
                ...
                <div style={{flex:1,width:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",paddingTop:8,minHeight:0}}>
                  ...
                  <div style={{width:isMobile?120:168,height:isMobile?120:168,display:"flex",alignItems:"center",justifyContent:"center"}}>
                    <div style={{width:isMobile?120:168,height:isMobile?120:168,display:"flex",alignItems:"center",justifyContent:"center",transform:"translateX(-2px)"}}>
                      {signatureGlyph(true)}
                    </div>
                  </div>
        ...
        {step===3 && tutorialMoment && sofiaProfile && (
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:isMobile?10:16,flex:1,minHeight:0}}>
