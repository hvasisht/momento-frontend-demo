...
function TopChrome({
  ...
  return (
    ...
    <header style={{height:48,display:"flex",alignItems:"center",padding:"0 16px",gap:12,background:isRead ? "transparent" : darkMode ? "rgba(24,20,16,0.82)" : "rgba(250,247,239,0.72)",backdropFilter:isRead ? "none" : "blur(12px)",WebkitBackdropFilter:isRead ? "none" : "blur(12px)",borderBottom:isRead ? "none" : `1px solid ${darkMode?"rgba(196,160,85,0.1)":"rgba(139,105,20,0.12)"}`,boxShadow:"none",position:"absolute",top:0,left:0,right:0,zIndex:10,transition:"background 350ms ease, border-color 350ms ease"}}>
      ...
      {!isMobile && <div style={{position:"absolute",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",zIndex:2}}>
      ...
      {isWorthSolo && worthMessage && !isMobile && (
      ...
      {!isMobile && <div style={{position:"absolute",right:16,top:"50%",transform:"translateY(-50%)",display:"flex",alignItems:"center",gap:8,zIndex:3}}>
        {isSharingSolo && (
    ...
    <div className="momento-cube-widget" style={{position:"fixed",bottom:24,right:28,zIndex:50}} onMouseEnter={()=>setShowHint(true)} onMouseLeave={()=>setShowHint(false)}>
